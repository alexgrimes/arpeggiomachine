...
const KeyInfo = () => {
  ...
  chordAnalysisGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, width: '100%' },
  chordColumn: { flex: 1, flexBasis: 0, flexDirection: 'column', alignItems: 'center', borderWidth: 1, borderColor: '#ddd', borderRadius: 6, paddingVertical: 6, backgroundColor: '#f9f9f9', minWidth: 65, marginHorizontal: 2 },
